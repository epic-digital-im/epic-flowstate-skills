...
digraph process {
    ...
    "Proceed to next flowstate step" [shape=box style=filled fillcolor=lightgreen];

    "Read plan, extract all tasks with full text, create task list" -> "Dispatch implementer subagent";
    ...
    "Dispatch final code reviewer for entire implementation" -> "Proceed to next flowstate step";
}
```
